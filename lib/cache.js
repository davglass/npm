...
function unpackTar (tarball, unpackTarget, dMode, fMode, uid, gid, cb) {
  ...
  if (typeof cb !== "function") cb = fMode, fMode = 0666
  if (typeof cb !== "function") cb = dMode, dMode = 0777
...
function unpackTar_ ( tarball, unpackTarget, dMode, fMode, uid, gid, cb ) {
  mkdir(unpackTarget, dMode || 0755, uid, gid, function (er) {
